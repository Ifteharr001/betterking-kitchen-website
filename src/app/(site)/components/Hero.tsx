...
const slides = [
  {
    id: 1,
    badge: "Premium Kitchen Solutions",
    title: "Built for the",
    highlight: "Culinary Elite",
    description: "Betterking delivers high-performance commercial kitchen equipment designed for durability, efficiency, and precision.",
    video: null,
    image: heroImage, 
    overlay: "bg-gradient-to-r from-[#0a1628]/95 via-[#0a1628]/70 to-[#0a1628]/30",
    cta: { primary: "Explore Products", secondary: "View Projects" }
  },
  {
    id: 2,
    badge: "Industrial Grade Equipment",
    title: "Power Your",
    highlight: "Commercial Kitchen",
    description: "From five-star hotels to high-volume restaurants, our equipment delivers consistent performance under the most demanding conditions.",
    video: "/videos/hero-video-2.mp4",
    image: heroImage,
    overlay: "bg-gradient-to-r from-[#0a1628]/95 via-[#0a1628]/70 to-[#0a1628]/30",
    cta: { primary: "Browse Catalog", secondary: "Get a Quote" }
  },
  {
    id: 3,
    ...
    description: "Join 500+ hospitality brands who trust Betterking for their kitchen infrastructure. Quality that speaks for itself.",
    video: "/videos/hero-video-3.mp4",
    image: heroImage,
    overlay: "bg-gradient-to-r from-[#1a3a5c]/90 via-[#1a3a5c]/60 to-[#1a3a5c]/20",
    cta: { primary: "Our Projects", secondary: "Contact Us" }
  }
];
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <button className="btn-gold text-sm md:text-base">
                  {slide.cta.primary}
                </button>
                <button className="inline-flex items-center justify-center gap-2 px-5 md:px-6 py-3 text-sm font-semibold rounded-lg border border-white/30 text-white hover:bg-white/10 transition-all duration-300">
                  {slide.cta.secondary}
