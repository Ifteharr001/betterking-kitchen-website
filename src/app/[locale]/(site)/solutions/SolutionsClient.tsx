...
const BeforeAfterSlider = ({ t }: { t: any }) => {
  ...
  return (
    ...
    >
      <img src="https://i.ibb.co.com/v4QPffdS/220120-055.jpg" alt="After" className="absolute inset-0 w-full h-full object-cover" />
...
const SolutionsClient = ({ initialIndustries, initialCategories }: { initialIndustries: any[], initialCategories: any[] }) => {
  const t = useTranslations("SolutionsPage");
  const locale = useLocale();

  const industries = initialIndustries;
  const categories = initialCategories;

  const iconMap: any = { 0: Building2, 1: UtensilsCrossed, 2: GraduationCap, 3: Hospital, 4: Cake, 5: Coffee };
      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
            ...
            <p className="section-subtitle mx-auto max-w-xl">{t("heroDesc")}</p>
          </div>
        </section>
              ...
              {industries.map((ind, i) => {
                ...
                return (
                  <Link href={`/${locale}/industries/${ind._id}`} key={ind._id}>
                    <div className="group rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-all duration-300 bg-white">
                      ...
                      <div className="p-5">
                        ...
                        <p className="text-sm text-gray-500 line-clamp-2">{getLocalizedText(ind.description, locale)}</p>
                      </div>
                    </div>
                  </Link>
                );
