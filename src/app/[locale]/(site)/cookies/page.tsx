          ...
          <div className="space-y-8 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-3 space-y-2 text-gray-600">
                <li><strong className="text-gray-900">{t("point1Title")}:</strong> {t("point1Desc")}</li>
                <li><strong className="text-gray-900">{t("point2Title")}:</strong> {t("point2Desc")}</li>
                <li><strong className="text-gray-900">{t("point3Title")}:</strong> {t("point3Desc")}</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">{t("section5Title")}</h2>
