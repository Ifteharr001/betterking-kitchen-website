...
const AdminDashboard = () => {
  ...
  const [recentQuotes, setRecentQuotes] = useState<Quote[]>([
    { _id: "1", name: "Xinyi nixyi", email: "Xinyi@gmail.com", subject: "Inquiry about Industrial Oven", status: "new", date: "2026-02-17" },
    { _id: "2", name: "Zhenhua", email: "info@Zhenhua.com", subject: "Quote for 500L Mixer", status: "read", date: "2026-02-16" },
    { _id: "3", name: "Sultana Kitchens", email: "sultana@yahoo.com", subject: "Partnership Proposal", status: "replied", date: "2026-02-15" },
    { _id: "4", name: "sianku siajki", email: "siajki.a@gmail.com", subject: "Custom Kitchen Design", status: "new", date: "2026-02-14" },
    { _id: "5", name: "giun en", email: "contact@giunen.com", subject: "Service Request", status: "pending", date: "2026-02-13" },
  ]);
            ...
            {recentQuotes.map((q) => (
              <div key={q._id} className="flex items-center justify-between p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors border border-transparent hover:border-gray-200 group">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5 font-medium">{q.subject}</p>
                ...
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-gray-400 mt-2">{q.date}</p>
                </div>
              </div>
            ))}
          </CardContent>
